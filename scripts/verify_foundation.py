...
STACK_KEYWORDS = [
    ...
    "no API artifact ingestion/storage",
    "no API file upload/download",
    "no API artifact reference fetch",
    "no API paper parsing",
    "no API placeholder-as-validated-artifact",
    "no API artifact-as-strategy-output",
    "no API artifact-as-recommendation",
    "Research Artifact Registry API Contract Skeleton",
    "Prompt 72",
    ...
    "Planning Milestone Audit",
    "API Milestone Audit",
    "Display Milestone Audit",
    "Safety Milestone Audit",
    "Prompts 70-73",
    "no active artifact ingestion",
    "no persistent artifact storage",
    "no upload/download",
    ...
    "Research Metadata Graph Planning Phase - Planning and Guardrails",
    "Prompt 85",
    "Research Metadata Graph API Contract Skeleton",
    "Research Metadata Graph Status: planning/guardrails and API contract skeleton only",
    "Research Metadata Graph Planning Phase - API Contract Skeleton",
    "Prompt 86",
    ...
    "Research Metadata Graph Planning Phase - Display Contract Skeleton",
    "Prompt 87",
    ...
    "Research Metadata Graph Planning Phase - Safety Boundary Audit",
    "Prompts 84-86",
    ...
    "Research Metadata Graph Phase Closure and Forward Transition",
    ...
    "Research Knowledge Map Planning Phase - Planning and Guardrails",
    "Prompt 90",
    "Research Knowledge Map API Contract Skeleton",
    "Research Knowledge Map Planning Phase - API Contract Skeleton",
    "Research Knowledge Map API Contract Skeleton complete",
    "Prompt 91",
    ...
    "Research Knowledge Map Planning Phase - Display Contract Skeleton",
    "Research Knowledge Map Display Contract Skeleton complete",
    "Prompt 92",
    ...
    "Research Knowledge Map Planning Phase - Safety Boundary Audit",
    "Research Knowledge Map Safety Boundary Audit complete",
    "Planning safety verdict",
    "API safety verdict",
    "Display safety verdict",
    ...
    "Research Knowledge Map Planning Phase - Phase Closure",
    "Research Knowledge Map Phase Closure complete",
    "Prompt 94",
    ...
    "Retail Decision Console Productization - Static State Wired into Desktop Shell",
    ...
    "static-state view-model",
    "Prompt 99",
    "Retail Decision Console Local Preview Runbook and Manual Smoke Test",
    "Retail Decision Console Productization - Local Preview and Smoke Test",
    ...
    "Retail Decision Console Productization - Visual Layout Pass",
    ...
    "Prompt 101",
    "Retail Decision Console Productization - Static Interaction Placeholders",
    ...
    "Retail Decision Console Productization - Preview Snapshot Export",
    ...
    "Retail Decision Console Productization - Local QA Bundle",
    ...
    "Retail Decision Console Productization - Manual Acceptance Checklist",
    ...
    "Retail Decision Console Productization - Shareable Internal Preview Package",
    ...
    "Retail Decision Console Productization - Internal Preview Smoke Verification",
    "Retail Decision Console Status: internal preview package smoke-verified; still static/demo/unavailable only",
    "internal_preview_smoke_verification",
    "internal_preview_smoke.py",
    "smoke_verify_retail_decision_console_internal_preview.py",
    "--package-dir tmp/retail_decision_console_internal_preview --print-summary",
    "Prompt 107 - Retail Decision Console Internal Preview Milestone Closure",
    "Retail Decision Console Internal Preview - Closed",
    ...
    "commit/push before starting next phase",
