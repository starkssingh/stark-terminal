...
class ResearchArtifactIndexProvenanceDisplayPlaceholder(BaseModel):
    provenance_display_id: str
    provenance_reference_placeholder: str = "index-provenance-reference-placeholder"
    ...
    def text_fields_must_be_non_empty(cls, value: str) -> str:
        return non_empty_text(value, "research artifact index provenance display placeholder text fields")
    ...
    def provenance_display_must_fail_closed(self) -> ResearchArtifactIndexProvenanceDisplayPlaceholder:
...
def default_research_artifact_index_provenance_display_placeholder() -> ResearchArtifactIndexProvenanceDisplayPlaceholder:
    return ResearchArtifactIndexProvenanceDisplayPlaceholder(
        provenance_display_id="research-artifact-index-provenance-display-placeholder-v1",
