...
@router.get("/research-knowledge-map-api/health")
def research_knowledge_map_api_health_endpoint() -> dict[str, Any]:
    status = research_knowledge_map_api_health(get_settings())
    return {
        **_base_response(),
...
@router.get("/research-knowledge-map-api/contracts")
def research_knowledge_map_api_contracts_endpoint() -> dict[str, Any]:
    contract = default_research_knowledge_map_api_contract(get_settings())
    return {
        **_base_response(),
        "contract": contract.model_dump(mode="json"),
        "forbidden_actions": list(research_knowledge_map_api_forbidden_actions()),
    }


@router.get("/research-knowledge-map-api/unavailable-template")
def research_knowledge_map_api_unavailable_template_endpoint() -> dict[str, Any]:
    return {
        **_base_response(),
        "unavailable_response": unavailable_knowledge_map_api_response_template().model_dump(mode="json"),
    }


@router.get("/research-knowledge-map-api/request-placeholder")
def research_knowledge_map_api_request_placeholder_endpoint() -> dict[str, Any]:
    return {
        **_base_response(),
        "request_placeholder": default_research_knowledge_map_request_placeholder().model_dump(mode="json"),
        "request_placeholders": {
            "item": default_knowledge_item_lookup_request_placeholder().model_dump(mode="json"),
            "relationship": default_knowledge_relationship_request_placeholder().model_dump(mode="json"),
            "evidence": default_knowledge_evidence_request_placeholder().model_dump(mode="json"),
            "provenance": default_knowledge_provenance_request_placeholder().model_dump(mode="json"),
        },
...
@router.get("/research-knowledge-map-api/response-placeholder")
def research_knowledge_map_api_response_placeholder_endpoint() -> dict[str, Any]:
    return {
        **_base_response(),
        "response_placeholder": default_research_knowledge_map_response_placeholder().model_dump(mode="json"),
        "response_placeholders": {
            "item": default_knowledge_item_response_placeholder().model_dump(mode="json"),
            "relationship": default_knowledge_relationship_response_placeholder().model_dump(mode="json"),
            "evidence": default_knowledge_evidence_response_placeholder().model_dump(mode="json"),
            "provenance": default_knowledge_provenance_response_placeholder().model_dump(mode="json"),
        },
        "no_retrieved_map_data": True,
...
@router.get("/research-knowledge-map-api/reference-placeholder")
def research_knowledge_map_api_reference_placeholder_endpoint() -> dict[str, Any]:
    return {
        **_base_response(),
        "api_reference": default_knowledge_map_api_reference_placeholder().model_dump(mode="json"),
        "item_reference": default_knowledge_map_item_reference_placeholder().model_dump(mode="json"),
        "relationship_reference": default_knowledge_map_relationship_reference_placeholder().model_dump(mode="json"),
        "provenance_reference": default_knowledge_map_provenance_reference_placeholder().model_dump(mode="json"),
        "no_fetch": True,
        "no_retrieval": True,
