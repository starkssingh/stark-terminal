...
def test_api_package_has_no_strategy_backtest_recommendation_or_execution_functions() -> None:
    text = _source_text()
    forbidden = [
...
def test_api_route_has_no_execution_or_broker_like_paths() -> None:
...
def test_api_package_has_no_active_trade_call_terms() -> None:
    text = _source_text()
    forbidden_terms = [
        "DecisionObject(",
        "confidence_score",
