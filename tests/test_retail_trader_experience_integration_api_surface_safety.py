...
def test_api_surface_inventory_includes_retail_trader_experience_endpoint_families() -> None:
    ...
    for phrase in [
        ...
        "do not create suitability profiles",
...
def test_retail_trader_experience_api_surface_has_no_post_or_secret_exposure() -> None:
    ...
    for endpoint in ENDPOINTS:
        ...
        assert "live_market_data': True" not in repr(body)
