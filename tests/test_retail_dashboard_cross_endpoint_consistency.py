...
def test_retail_dashboard_endpoint_families_are_safe_and_consistent() -> None:
    for endpoint in DASHBOARD_ENDPOINTS:
        ...
        assert "execution_ready': True" not in repr(body)


def test_retail_dashboard_endpoint_families_have_no_post_methods() -> None:
